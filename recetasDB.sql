...
-- Table `mydb`.`pasos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`pasos` ;

CREATE TABLE IF NOT EXISTS `mydb`.`pasos` (
...
-- -----------------------------------------------------
-- Table `mydb`.`recetas_has_ingredientes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`recetas_has_ingredientes` ;

CREATE TABLE IF NOT EXISTS `mydb`.`recetas_has_ingredientes` (
  `Recetas_idRecetas` INT(11) NOT NULL,
